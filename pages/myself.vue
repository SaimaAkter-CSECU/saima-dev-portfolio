...
<template>
    <div>
        ...
        <section class="w3l-services">
            <div class="w3l-achievements py-5" id="services">
                <div class="container py-lg-5">
                    <h5 class="title-small text-center">My achievements &amp; trainings</h5>
                    <h3 class="title-big text-center mb-sm-5 mb-4">Personal Awards &amp; Trainings</h3>
                    <div class="row">
